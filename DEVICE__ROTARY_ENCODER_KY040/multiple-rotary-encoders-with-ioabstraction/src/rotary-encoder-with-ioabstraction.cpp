...
void setup() {
  ...
  //  interrupts simultaneously. If using SWITCHES_NO_POLLING then the button
  //  press does not work, while SWITCHES_POLL_KEYS_ONLY works.
  ...
  rotaryB->changePrecision(10,     // max value.
                           0,      // starting value.
                           false,  // Wrap around after hitting min and max.
                           1       // step size.
  );
